...
export default function Login(){
  return(
    ...
    <body>
      ...
      {/*PARTE DO HIDDEN*/}
        <div className="hidden lg:flex bg-[#2968B2] p-5 w-[40%] h-[75%] rounded-3xl items-center justify-center">
      ...
      {/*PARTE DO APARENTE*/}
        <div className= "p-5 w-[80%] h-[75%] lg:w-[40%] bg-[#F8EB78] rounded-3xl flex items-center justify-center">
