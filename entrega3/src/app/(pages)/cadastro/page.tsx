  ...
  return (
    <div className= "w-[100vw] h-[100vh] flex flex-col items-center justify-center bg-[#F9E9BF]"> 
      <div className="w-[100%] h-[10%]">
        ...
        <div className= "p-5 w-[90%] h-[90%] lg:w-[70%] bg-[#02479A] rounded-3xl flex flex-col items-center justify-start">
          
          <div className="p-5 w-[100%] h-[15%] flex flex-col justify-center">
            <h1 className={`text-center text-[#f1e255] ${playfair_display.className} font-black text-4xl`}>Cadastro</h1>
          </div>
